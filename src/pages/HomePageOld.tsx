    ...
    <main>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            src={heroImage}
            alt="Layanan transportasi profesional di Surabaya dengan latar belakang kota"
      ...
      {/* Armada Lepas Kunci Section */}
      <section className="bg-secondary/30 py-16 md:py-24">
        <div className="container">
          <div className="mb-12 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end opacity-0 animate-fade-up">
            <div>
              ...
              <h2 className="mb-2 text-2xl font-bold md:text-3xl">
                Pilihan Armada untuk Sewa Lepas Kunci
              </h2>
              <p className="max-w-xl text-muted-foreground">
                Familiar dengan Surabaya dan ingin menyetir sendiri? Berikut
                pilihan armada yang bisa Anda gunakan.
              </p>
            </div>
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="space-y-1 text-sm text-muted-foreground">
                    <p>{car.capacity}</p>
                    <p className="text-xs">{car.useCase}</p>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="mt-8 text-center opacity-0 animate-fade-up delay-300">
            <p className="mb-4 text-sm text-muted-foreground">
              Tidak yakin mobil mana yang cocok? Konsultasikan kebutuhan Anda.
            </p>
            <Button variant="cta" size="lg" asChild>
              <a
                href={`${WHATSAPP_LINK}&text=Halo,%20saya%20ingin%20sewa%20mobil%20lepas%20kunci%20di%20Surabaya`}
                target="_blank"
                rel="noopener noreferrer"
              >
                <Phone className="h-5 w-5" />
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div className="grid grid-cols-2 gap-4 opacity-0 animate-fade-up delay-200">
              <div className="space-y-4">
                <img
                  src={driverImage}
                  alt="Sopir profesional membuka pintu untuk penumpang"
                  className="aspect-square rounded-2xl object-cover shadow-card"
                />
                <img
                  src={familyImage}
                  alt="Keluarga bahagia dalam perjalanan"
                  className="aspect-video rounded-2xl object-cover shadow-card"
                />
              </div>
              <div className="mt-8 space-y-4">
                <img
                  src={airportImage}
                  alt="Layanan antar jemput Bandara Juanda Surabaya"
                  className="aspect-video rounded-2xl object-cover shadow-card"
                />
